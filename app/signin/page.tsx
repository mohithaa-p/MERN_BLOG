          ...
          <div className="relative">
            ...
            <div className="bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-8 relative">
              <div className="text-center mb-8">
                ...
                <p className="text-zinc-600 dark:text-zinc-400 mt-2">Sign in to your account to continue</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="text-center text-sm">
                  ...
                  <Link href="/signup" className="text-emerald-600 dark:text-emerald-500 hover:underline font-medium">
                    Sign up
                  </Link>
                </div>
              </div>
